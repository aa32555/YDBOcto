...
-- This query will throw ERR_GROUP_BY_EXPRESSION as the select column expression is not in GroupBy.
-- Added here to demonstrate that ERR_GROUP_BY_EXPRESSION is thrown if it exists.
select firstname=id from names group by firstname=1;
-- This query shows that if a query get past the ERR_GROUP_BY_EXPRESSION the checks in populate_data_type()
...
SELECT coalesce(lastname) FROM names GROUP BY coalesce(lastname) HAVING coalesce(lastname)!='COOL' ORDER BY coalesce(lastname); -- Postgres error saying lastname not in Group By
...
select count(DISTINCT lastname) from names group by count(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(DISTINCT lastname) from names group by count(DISTINCT lastname) having 1!=count(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(DISTINCT lastname) from names group by count(DISTINCT lastname) having 1!=count(DISTINCT lastname) order by count(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(DISTINCT lastname) from names group by count(DISTINCT lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(DISTINCT lastname) from names group by count(DISTINCT lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(DISTINCT lastname) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(DISTINCT lastname) from names group by 1 having 1!=count(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(DISTINCT lastname) from names group by 1 having 1!=count(DISTINCT lastname) order by count(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(DISTINCT lastname) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(DISTINCT lastname) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(DISTINCT lastname) having 1!=count(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(DISTINCT lastname) having 1!=count(DISTINCT lastname) order by count(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(DISTINCT lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(DISTINCT lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select MAX(DISTINCT lastname) from names group by MAX(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(DISTINCT lastname) from names group by MAX(DISTINCT lastname) having 'Burn'!=MAX(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(DISTINCT lastname) from names group by MAX(DISTINCT lastname) having 'Burn'!=MAX(DISTINCT lastname) order by MAX(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(DISTINCT lastname) from names group by MAX(DISTINCT lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(DISTINCT lastname) from names group by MAX(DISTINCT lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(DISTINCT lastname) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(DISTINCT lastname) from names group by 1 having 'Burn'!=MAX(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(DISTINCT lastname) from names group by 1 having 'Burn'!=MAX(DISTINCT lastname) order by MAX(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(DISTINCT lastname) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(DISTINCT lastname) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(DISTINCT lastname) having 'Burn'!=MAX(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(DISTINCT lastname) having 'Burn'!=MAX(DISTINCT lastname) order by MAX(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(DISTINCT lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(DISTINCT lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select MIN(DISTINCT lastname) from names group by MIN(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(DISTINCT lastname) from names group by MIN(DISTINCT lastname) having 'Burn'!=MIN(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(DISTINCT lastname) from names group by MIN(DISTINCT lastname) having 'Burn'!=MIN(DISTINCT lastname) order by MIN(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(DISTINCT lastname) from names group by MIN(DISTINCT lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(DISTINCT lastname) from names group by MIN(DISTINCT lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(DISTINCT lastname) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(DISTINCT lastname) from names group by 1 having 'Burn'!=MIN(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(DISTINCT lastname) from names group by 1 having 'Burn'!=MIN(DISTINCT lastname) order by MIN(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(DISTINCT lastname) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(DISTINCT lastname) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(DISTINCT lastname) having 'Burn'!=MIN(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(DISTINCT lastname) having 'Burn'!=MIN(DISTINCT lastname) order by MIN(DISTINCT lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(DISTINCT lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(DISTINCT lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select SUM(DISTINCT id) from names group by SUM(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(DISTINCT id) from names group by SUM(DISTINCT id) having 1!=SUM(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(DISTINCT id) from names group by SUM(DISTINCT id) having 1!=SUM(DISTINCT id) order by SUM(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(DISTINCT id) from names group by SUM(DISTINCT id) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(DISTINCT id) from names group by SUM(DISTINCT id) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(DISTINCT id) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(DISTINCT id) from names group by 1 having 1!=SUM(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(DISTINCT id) from names group by 1 having 1!=SUM(DISTINCT id) order by SUM(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(DISTINCT id) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(DISTINCT id) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(DISTINCT id) having 1!=SUM(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(DISTINCT id) having 1!=SUM(DISTINCT id) order by SUM(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(DISTINCT id) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(DISTINCT id) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select AVG(DISTINCT id) from names group by AVG(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(DISTINCT id) from names group by AVG(DISTINCT id) having 1!=AVG(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(DISTINCT id) from names group by AVG(DISTINCT id) having 1!=AVG(DISTINCT id) order by AVG(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(DISTINCT id) from names group by AVG(DISTINCT id) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(DISTINCT id) from names group by AVG(DISTINCT id) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(DISTINCT id) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(DISTINCT id) from names group by 1 having 1!=AVG(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(DISTINCT id) from names group by 1 having 1!=AVG(DISTINCT id) order by AVG(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(DISTINCT id) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(DISTINCT id) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(DISTINCT id) having 1!=AVG(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(DISTINCT id) having 1!=AVG(DISTINCT id) order by AVG(DISTINCT id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(DISTINCT id) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(DISTINCT id) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select count(lastname) from names group by count(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(lastname) from names group by count(lastname) having 1!=count(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(lastname) from names group by count(lastname) having 1!=count(lastname) order by count(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(lastname) from names group by count(lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(lastname) from names group by count(lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(lastname) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(lastname) from names group by 1 having 1!=count(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(lastname) from names group by 1 having 1!=count(lastname) order by count(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(lastname) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(lastname) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(lastname) having 1!=count(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(lastname) having 1!=count(lastname) order by count(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select MAX(lastname) from names group by MAX(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(lastname) from names group by MAX(lastname) having 'Burn'!=MAX(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(lastname) from names group by MAX(lastname) having 'Burn'!=MAX(lastname) order by MAX(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(lastname) from names group by MAX(lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(lastname) from names group by MAX(lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(lastname) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(lastname) from names group by 1 having 'Burn'!=MAX(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(lastname) from names group by 1 having 'Burn'!=MAX(lastname) order by MAX(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(lastname) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MAX(lastname) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(lastname) having 'Burn'!=MAX(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(lastname) having 'Burn'!=MAX(lastname) order by MAX(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MAX(lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select MIN(lastname) from names group by MIN(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(lastname) from names group by MIN(lastname) having 'Burn'!=MIN(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(lastname) from names group by MIN(lastname) having 'Burn'!=MIN(lastname) order by MIN(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(lastname) from names group by MIN(lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(lastname) from names group by MIN(lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(lastname) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(lastname) from names group by 1 having 'Burn'!=MIN(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(lastname) from names group by 1 having 'Burn'!=MIN(lastname) order by MIN(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(lastname) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select MIN(lastname) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(lastname) having 'Burn'!=MIN(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(lastname) having 'Burn'!=MIN(lastname) order by MIN(lastname); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(lastname) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by MIN(lastname) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select SUM(id) from names group by SUM(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(id) from names group by SUM(id) having 1!=SUM(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(id) from names group by SUM(id) having 1!=SUM(id) order by SUM(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(id) from names group by SUM(id) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(id) from names group by SUM(id) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(id) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(id) from names group by 1 having 1!=SUM(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(id) from names group by 1 having 1!=SUM(id) order by SUM(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(id) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select SUM(id) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(id) having 1!=SUM(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(id) having 1!=SUM(id) order by SUM(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(id) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by SUM(id) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select AVG(id) from names group by AVG(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(id) from names group by AVG(id) having 1!=AVG(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(id) from names group by AVG(id) having 1!=AVG(id) order by AVG(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(id) from names group by AVG(id) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(id) from names group by AVG(id) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(id) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(id) from names group by 1 having 1!=AVG(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(id) from names group by 1 having 1!=AVG(id) order by AVG(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(id) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select AVG(id) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(id) having 1!=AVG(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(id) having 1!=AVG(id) order by AVG(id); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(id) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by AVG(id) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
...
select id between id and id+1 from names group by id between id and id+1 having id between id and id+2; -- POstgres error id not in Groupbvy
...
select id between id and id+1 from names group by 1 having id between id and id+2; -- POstgres error id not in Groupbvy
...
select id not between id and id+1 from names group by id not between id and id+1 having id not between id and id+2; -- POstgres error id not in Groupbvy
...
select id not between id and id+1 from names group by 1 having id not between id and id+2; -- POstgres error id not in Groupbvy
...
select lastname in ('Cool','Killer',NULL) from names group by lastname in ('Cool','Killer',NULL) having lastname in ('Cool',NULL, 'Killer'); -- postgres error lastname in having not in groupb y
...
select lastname in (firstname,'Killer',NULL) from names group by lastname in (firstname,'Killer',NULL) having lastname in (firstname,NULL, 'Killer'); -- postgres error lastname in having not in groupb y
...
select lastname in ('Cool','Killer',NULL) from names group by 1 having lastname in ('Cool',NULL, 'Killer'); -- postgres error lastname in having not in groupb y
...
select lastname in (firstname,'Killer',NULL) from names group by 1 having lastname in (firstname,NULL, 'Killer'); -- postgres error lastname in having not in groupb y
...
select 1 from names group by lastname in ('Cool','Killer',NULL) having lastname in ('Cool',NULL, 'Killer'); -- postgres error lastname in having not in groupb y
...
select 1 from names group by lastname in (firstname,'Killer',NULL) having lastname in (firstname,NULL, 'Killer'); -- postgres error lastname in having not in groupb y
...
select lastname in (select 'Cool') from names group by lastname in (select 'Cool') having lastname in (select 'Killer'); -- postgres error lastname in having not in groupb y
...
select lastname in (select lastname from names) from names group by lastname in (select lastname from names) having lastname in (select firstname from names); -- postgres error lastname in having not in groupb y
...
select lastname in (select 'Cool') from names group by 1 having lastname in (select 'Killer'); -- postgres error lastname in having not in groupb y
...
select lastname in (select lastname from names) from names group by 1 having lastname in (select firstname from names); -- postgres error lastname in having not in groupb y
...
select 1 from names group by lastname in (select 'Cool') having lastname in (select 'Killer'); -- postgres error lastname in having not in groupb y
...
select 1 from names group by lastname in (select lastname from names) having lastname in (select firstname from names); -- postgres error lastname in having not in groupb y asdf
...
-- All teh below should error as they are all having sub-queries in group by and this usage is not yet supported
...
-- COUNT(*) usage
select count(*) from names group by count(*); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(*) from names group by count(*) having 1!=count(*); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(*) from names group by count(*) having 1!=count(*) order by count(*); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(*) from names group by count(*) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(*) from names group by count(*) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(*) from names group by 1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(*) from names group by 1 having 1!=count(*); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(*) from names group by 1 having 1!=count(*) order by count(*); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(*) from names group by 1 having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select count(*) from names group by 1 having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(*); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(*) having 1!=count(*); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(*) having 1!=count(*) order by count(*); -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(*) having 1!=1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
select 1 from names group by count(*) having 1!=1 order by 1+1; -- Postgres erroro saying aggregate functions are not allowed in GroupBy
