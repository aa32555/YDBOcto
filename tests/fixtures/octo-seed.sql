...
CREATE FUNCTION extract(VARCHAR,DATE) RETURNS NUMERIC AS $$EXTRACT^%ydboctosqlfunctions;
CREATE FUNCTION extract(VARCHAR,TIME) RETURNS NUMERIC AS $$EXTRACT^%ydboctosqlfunctions;
CREATE FUNCTION extract(VARCHAR,TIME WITH TIME ZONE) RETURNS NUMERIC AS $$EXTRACT^%ydboctosqlfunctions;
CREATE FUNCTION extract(VARCHAR,TIMESTAMP) RETURNS NUMERIC AS $$EXTRACT^%ydboctosqlfunctions;
CREATE FUNCTION extract(VARCHAR,TIMESTAMP WITH TIME ZONE) RETURNS NUMERIC AS $$EXTRACT^%ydboctosqlfunctions;
CREATE FUNCTION extract(VARCHAR,INTERVAL) RETURNS NUMERIC AS $$EXTRACTINTERVAL^%ydboctosqlfunctions;
/* Alias for DAY */
...
CREATE FUNCTION dayofmonth(VARCHAR) RETURNS VARCHAR AS $$DAY^%ydboctosqlfunctions; /* Original varchar form is retained as this
									            ...
									            * for the literal.
									            */
/* Interval based functions with similar return type as Postgres + or - operation */
CREATE FUNCTION date_add(DATE, INTERVAL) RETURNS TIMESTAMP AS $$^%ydboctofDATEADD;
CREATE FUNCTION date_add(TIMESTAMP, INTERVAL) RETURNS TIMESTAMP AS $$^%ydboctofDATEADD;
CREATE FUNCTION date_add(TIMESTAMP WITH TIME ZONE, INTERVAL) RETURNS TIMESTAMP WITH TIME ZONE AS $$^%ydboctofDATEADD;
CREATE FUNCTION date_add(TIME, INTERVAL) RETURNS TIME AS $$^%ydboctofDATEADD;
CREATE FUNCTION date_add(TIME WITH TIME ZONE, INTERVAL) RETURNS TIME WITH TIME ZONE AS $$^%ydboctofDATEADD;
CREATE FUNCTION date_sub(DATE, INTERVAL) RETURNS TIMESTAMP AS $$^%ydboctofDATESUB;
CREATE FUNCTION date_sub(TIMESTAMP, INTERVAL) RETURNS TIMESTAMP AS $$^%ydboctofDATESUB;
CREATE FUNCTION date_sub(TIMESTAMP WITH TIME ZONE, INTERVAL) RETURNS TIMESTAMP WITH TIME ZONE AS $$^%ydboctofDATESUB;
CREATE FUNCTION date_sub(TIME, INTERVAL) RETURNS TIME AS $$^%ydboctofDATESUB;
CREATE FUNCTION date_sub(TIME WITH TIME ZONE, INTERVAL) RETURNS TIME WITH TIME ZONE AS $$^%ydboctofDATESUB;
