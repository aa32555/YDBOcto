...
DATESUB(date,type,year,month,day,hour,minute,second,microsecond)
	quit

PostgreSQL(date,type,year,month,day,hour,minute,second,microsecond)
	quit $$SubInterval^%ydboctoplanhelpers(date,type,year,month,day,hour,minute,second,microsecond)
